...
comment_corpus_name = "comments"
corpus = os.path.join("../../test_data", corpus_name)
comment_corpus = os.path.join("../../data", comment_corpus_name)
...
datafile = os.path.join(comment_corpus, "formatted_data.txt")
...
if(False):
    ...
    save_dir = os.path.join("../../test_data", "save")
